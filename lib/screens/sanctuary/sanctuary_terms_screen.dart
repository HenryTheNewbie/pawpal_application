...
class SanctuaryTermsScreen extends StatefulWidget {
  const SanctuaryTermsScreen({Key? key}) : super(key: key);

  @override
  State<SanctuaryTermsScreen> createState() => _SanctuaryTermsScreenState();
}

class _SanctuaryTermsScreenState extends State<SanctuaryTermsScreen> {
  String? _lastUpdated;
  ...
  Future<void> _loadTermsFromFirebase() async {
    try {
      final ref = FirebaseStorage.instance.ref().child('sanctuary_terms_of_use.json');
